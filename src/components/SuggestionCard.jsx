...
const SuggestionCard = () => {
    ...
    return (
        <div style={{ width: '100%' }} className='pt-5 mt-5'>
            <Row align={'center'} gutter={[32, 32]} className='mb-5'>
                <Col xs={24} md={24} lg={24} xl={16}>
                    <h5 className='mb-4' style={{ fontWeight: 'bold'}}>Unsere Empfehlung</h5>
                        ...
                        <div className='row'>
                            ...
                            <div className="col-md-6 col-lg-2 justify-content-start price-box" style={{ display: 'flex' }}>
                                <div className="abhebegebühren">
                                    <span className="cash_price">0,00 %</span>
                            ...
                            <div className="feature_wrap col-md-6 col-lg-3 d-flex align-items-start flex-column bullet-points">
                                <span className="kk_feature_1 kk_feature">
                                ...
                                <span className="kk_feature_2 kk_feature">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="19" viewBox="0 0 18 19" fill="none">
                                        <path fillRule="evenodd" clipRule="evenodd" d="M14.9954 4.57656C15.2292 4.78113 15.2529 5.1365 15.0483 5.37029L7.17332 14.3703C7.07081 14.4875 6.92432 14.5569 6.76872 14.5621C6.61312 14.5673 6.46234 14.5077 6.35225 14.3976L2.97725 11.0226C2.75758 10.803 2.75758 10.4468 2.97725 10.2271C3.19692 10.0075 3.55308 10.0075 3.77275 10.2271L6.7226 13.177L14.2017 4.62948C14.4062 4.39568 14.7616 4.37199 14.9954 4.57656Z" fill="#404674">
                                        </path>
                                    </svg>
                                ...
                                <span className="kk_feature_3 kk_feature">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="19" viewBox="0 0 18 19" fill="none">
                                        <path fillRule="evenodd" clipRule="evenodd" d="M14.9954 4.57656C15.2292 4.78113 15.2529 5.1365 15.0483 5.37029L7.17332 14.3703C7.07081 14.4875 6.92432 14.5569 6.76872 14.5621C6.61312 14.5673 6.46234 14.5077 6.35225 14.3976L2.97725 11.0226C2.75758 10.803 2.75758 10.4468 2.97725 10.2271C3.19692 10.0075 3.55308 10.0075 3.77275 10.2271L6.7226 13.177L14.2017 4.62948C14.4062 4.39568 14.7616 4.37199 14.9954 4.57656Z" fill="#404674">
                                        </path>
                                    </svg>
                    ...
                    <div className="fusion-text fusion-text-9 fusion-no-medium-visibility fusion-no-large-visibility" style={{marginRight:'20px',marginLeft:'20px',marginTop:'40px'}}>
                        <p>
                            <span dir="ltr" role="presentation"><strong>Hinweis</strong>: Dieser </span>
                            <span dir="ltr" role="presentation">Vergleich enthält keinen kompletten Marktüberblick.</span>
                        </p>
                        <p>
                            <span dir="ltr" role="presentation">Die Nutzung unseres Vergleichs ist für Dich vollkommen kostenlos. Wir </span>
                            <span dir="ltr" role="presentation">finanzieren uns über Provisionen. Wenn Du ein Finanzprodukt über uns beantragst</span>
                            <span dir="ltr" role="presentation">, erhalten wir vom Anbieter eine Vergütung. Dies hat jedoch keinen Einfluss auf </span>
                            <span dir="ltr" role="presentation">die Kosten Deiner Kreditkarte.</span>
                        </p>
                    </div>
                </Col>
            </Row>
